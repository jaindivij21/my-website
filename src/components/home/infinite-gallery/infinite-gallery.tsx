...
export const InfiniteGallery = () => {
  const animationClassNames = "animate-personal-gallery-images after:animate-personal-gallery-grain after:bg-grain after:bg-repeat after:content-[''] after:opacity-5 after:h-[300%] after:w-[300%] after:pointer-events-none after:fixed after:transition-opacity after:will-change-transform after:z-[1] after:left-[-100%] after:top-[-100%]"

  return (
    <div className='opacity-80'>
      {[...Array(2)].map((_, index) => (
        <div key={index} className={cn("grid grid-cols-2 md:grid-cols-4 gap-4 mb-4", animationClassNames)}>
          {
