...
import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from "@/components/shared/ui/building-blocks/form"
...
export const Newsletter = () => {
  ...
  return (
    <Card className="drop-shadow-2xl overflow-hidden">
      <CardContent className="p-0">
        <div className="relative isolate overflow-hidden bg-background px-4 py-8 md:p-8 lg:py-14">
          {/* Content */}

          {/* Title */}
          <h2 className="font-heading tracking-tight font-bold text-3xl x-sm:text-4xl">
            {NEWSLETTER.title}
          </h2>
          ...
          <div className="mt-6 flex flex-col gap-6 lg:mt-8 lg:flex-row lg:gap-16">
            ...
            <div className="flex flex-col">
              <div className="flex flex-row items-center">
                <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10 mr-5">
                  <Mailbox />
                </div>
                <dt className="font-heading font-semibold text-lg xl:text-2xl">
                  {NEWSLETTER.feature}
                </dt>
              </div>
              <dd className="mt-2 leading-7 text-gray-400 text-sm 2x-sm:text-base xl:text-lg">
